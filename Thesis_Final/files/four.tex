...
\begin{table}[h]
    ...
    $z$       & 1 & 1 & 2 &\\ \hline
    \end{tabular}
    \caption{\label{font-table} 1-hop pruning}
    \label{tab:dom_cand_pruned}
\end{table}
    By Table~\ref{tab:dom_cand_pruned}, $v$ and $x$ can be pruned by $u$. Also, $y$ can be pruned by $w$. Table~\ref{tab:dom_cand_pruned} show the result after pruning.
